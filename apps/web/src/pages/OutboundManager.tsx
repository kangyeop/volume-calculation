...
export const OutboundManager: React.FC = () => {
  ...
  const currentBatches = batches.sort(
  ...
  const fallbackUpload = async (file: File) => {
    try {
      ...
      reader.onload = async (evt) => {
        ...
        const XLSX = (window as unknown as { XLSX: { read: any; utils: { sheet_to_json: any } } })
          .XLSX;
  ...
  const processWithHardcodedMapping = async (
                  ...
                  <tr key={`${o.orderId}-${i}`} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-6 py-4 max-w-xs">
                      <div
                        ...
                        title={`${o.address} ${o.detailAddress || ''}`}
                      >
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-400">
                  {searchTerm
                    ...
                    : 'Upload your first Excel batch to get started'}
                </p>
              </div>
              {!searchTerm && (
                <button
